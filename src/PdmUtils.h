...
namespace PdmUtils
{
    ...
    static const char* MAX_USB_DEVICE_LIMIT_REACHED = "Exceeded maximum number of allowable USB storage. You can connect up to 6 USB storages to your device";
    static const char* DEVICE_UNSUPPORTED_FILESYSTEM = "This USB storage has an unsupported system and cannot be read.";
    ...
    void getToastText(std::string& text, std::string deviceType, std::string deviceStatus)
    {
